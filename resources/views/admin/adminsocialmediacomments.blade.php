                ...
                <form id="tabulator-html-filter-form" class="xl:flex sm:mr-auto">
                    <div class="sm:flex items-center sm:mr-4">
                        ...
                        <select id="tabulator-html-filter-field" class="form-select w-full sm:w-32 2xl:w-full mt-2 sm:mt-0 sm:w-auto">
                            ...
                            <option value="category">Genaral</option>
                            <option value="remaining_stock">MA</option>
                            <option value="remaining_stock">SAR</option>
                            <option value="remaining_stock">Dean</option>
                            <option value="remaining_stock">AR</option>
                            <option value="remaining_stock">DVC</option>
                        </select>
                    </div>
